...
syntax match nmap_header /PORT\s\+STATE\s\+SERVICE\s\+VERSION/
highlight nmap_header_format ctermfg=19
highlight link nmap_header nmap_header_format
"Nmap openports 
"\d+\/(tcp|udp)\s+open
...
" [[ Highlight TimeStamp - fo rmat: YYYY-MM-DD-hh:mm:ss
...
"[[ Highlight IPv6 Address wit h Compression
